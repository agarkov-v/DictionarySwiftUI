...
//class GameCollectionViewCell: SwiftUICollectionViewCell<Text> {
//
//    func configure(with definitionItem: DefinitionItem, parent: UIViewController) {
//        embed(in: parent, withView: Text(definitionItem.text))
